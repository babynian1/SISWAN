...
<div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
    <div class="mb-1 w-full">
        <div class="mb-4">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#" class="text-gray-700 hover:text-gray-900 ml-1 md:ml-2 text-sm font-medium">Unit</a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
            ...
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Data Unit</h1>
        </div>
        <div class="sm:flex">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200" id="tbl_list">
                        ...
                        <tr>
                            ...
                            <td class="p-4 whitespace-nowrap space-x-2">
                                <button type="button" data-modal-toggle="edit-unit-modal" onclick="EditUnit({{$unit->id}})" id="editModal" class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                                ...
                                <button type="button" data-modal-toggle="delete-unit-modal" onclick="DeleteUnit({{$unit->id}})" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                                    <svg class="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
...
@include('admin.unit.modal.add')
@include('admin.unit.modal.edit')
@include('admin.unit.modal.delete')
