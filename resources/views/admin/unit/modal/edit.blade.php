            ...
            <form method="POST" action="{{route('unit.update')}}" >
                ...
                <div class="grid grid-cols-2 gap-6 p-4">
                    <div class="col-span-12 sm:col-span-3">
                        <label for="name_unit" class="text-sm font-medium text-gray-900 block mb-2">Nama Unit</label>
                        <input type="text" name="name_unit" id="name_unit" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Ex: CSSD" required>
                    </div>
                    <div class="col-span-12 sm:col-span-3">
                        <label for="desc_unit" class="text-sm font-medium text-gray-900 block mb-2">Deskripsi Unit</label>
                        <textarea name="desc_unit" id="desc_unit" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"></textarea>
                    </div>
                </div>
